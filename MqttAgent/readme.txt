The OPC UA IoT Toolkit is an implementation of OPC UA PubSub over MQTT using the JSON encoding. It is designed to illustrate how to a fully compliant OPC UA PubSub implementation can be developed quickly using freely available MQTT and JSON libraries.
